...
public class Extrasfeld extends Feld
{
	...
	public void draw(int x, int y){
		...
		switch(art)
		{
			case 1: {}//Dieses Feld generiert ein zusaetzliches Leben, um einen Bombentreffer zu ueberleben}
			...
			case 5: {}//Dieses Feld generiert eine temporaere Steuerungsbehinderung fuer alle feindlichen/anderen Spieler. Alle außer der Spieler, der das Feld betritt, unterliegen einer umgekehrten Steuerung (Ausnahme: Bombe legen)
			...
			case 7: {}//Dieses Feld generiert ein Upgrade, welches einen temporaeren Geschwindigkeitsbonus für den Spieler gibt, der es aufsammelt
